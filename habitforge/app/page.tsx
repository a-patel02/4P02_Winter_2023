    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-8 md:p-24">
      ...
      <div className="flex flex-col w-full">
        ...
        <div id="gray-box" className="flex flex-row gap-10">
          <div
            id="labelAndText"
            className="flex flex-col bg-[#F1F5F9] w-60 mt-5 rounded-lg p-2"
          >
            <Typography
              variant="p"
              affects={"lead"}
            ...
            <Typography variant="h3" className="!mt-0 pt-2">
              10
            </Typography>
          </div>
        </div>
        <div id="completionBox" className="flex flex-col gap-3 mt-10">
          ...
          <div className="flex flex-row">
            <div
              id="habit"
              className="flex flex-row items-center outline rounded-lg p-3 gap-3"
            >
              <Icon color="blue">
                <Zap />
              </Icon>
